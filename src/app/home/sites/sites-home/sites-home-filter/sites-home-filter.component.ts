...
import { FilterOption, FilterOptions } from './sites-home-filter.model';

@Component({
  selector: 'app-sites-home-filter',
  templateUrl: './sites-home-filter.component.html',
  styleUrls: ['./sites-home-filter.component.scss'],
})
export class SitesHomeFilterComponent implements OnInit {
