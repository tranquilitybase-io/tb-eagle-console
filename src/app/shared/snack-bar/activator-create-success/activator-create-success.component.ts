...
@Component({
  ...
  templateUrl: './activator-create-success.component.html',
  styleUrls: ['./activator-create-success.component.scss']
})
export class ActivatorCreateSuccessComponent extends MatSnackBar {
  constructor(
