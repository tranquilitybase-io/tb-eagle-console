...
@Component({
  selector: 'app-connection-is-deployed',
  templateUrl: './connection-is-deployed.component.html',
  styleUrls: ['./connection-is-deployed.component.scss']
})
export class ConnectionIsDeployedComponent extends MatSnackBar {
  constructor(
